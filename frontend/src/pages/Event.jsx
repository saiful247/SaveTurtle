        ...
        <table className='w-full border-separate border-spacing-2'>
          <thead>
            <tr>
              ...
              <th className='border border-slate-600 rounded-md max-md:hidden'>Event Name</th>
              <th className='border border-slate-600 rounded-md max-md:hidden'>Vanue</th>
          ...
          <tbody>
            {filteredEvents.map((eventP, index) => (
              <tr key={eventP._id} className='h-8'>
                ...
                <td className='border border-slate-700 rounded-md text-center'>{eventP.eventName}</td>
                <td className='border border-slate-700 rounded-md text-center max-md:hidden'>{eventP.vanue}</td>
                <td className='border border-slate-700 rounded-md text-center max-md:hidden'>{eventP.date}</td>
                <td className='border border-slate-700 rounded-md text-center max-md:hidden'>{eventP.time}</td>
                <td className='border border-slate-700 rounded-md text-center max-md:hidden'>{eventP.price}</td>
