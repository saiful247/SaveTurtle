  ...
  return (
    <div className="p-4">
      ...
      <div className="flex flex-col border-2 border-sky-400 rounded-xl w-[600px] p-4 mx-auto">
        <div className="my-4">
          <label className="text-xl mr-4 text-gray-500">Participant Name</label>
          <input
            type="text"
        ...
        <div className="my-4">
          <label className="text-xl mr-4 text-gray-500">Upload Payment Image</label>
          <input type="file" onChange={handleImageChange} />
        </div>
        <div className="my-4 bg-red-100 p-4 rounded-md">
        <p className="text-gray-700">
            <strong>Attention:</strong> Please upload your payment document here. We will process your payment and let you know as soon as possible about the success or rejection of the payment. Here are the payment details:
        </p>
