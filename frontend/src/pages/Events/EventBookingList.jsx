...
const EventBookData = () => {
  ...
  const totalAmount = filteredParticipants.reduce(
    (sum, participant) => sum + parseFloat(participant.ticketPrice),
    0
  );
                    ...
                    <tr key={participant._id}>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        {participant.paymentImageUrl ? (
                          <a
                            href={`http://localhost:5555${participant.paymentImageUrl}`}
                            target="_blank"
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                        <div className="mt-4 flex justify-center gap-x-4">
                          <button
                            ...
                            onClick={() =>
                              sendEmail(participant.email, "approved")
                            } // On Approve, send approval email
                          >
                            Approve
                          </button>
                          <button
                            ...
                            onClick={() =>
                              sendEmail(participant.email, "disapproved")
                            } // On Disapprove, send disapproval email
                          >
                            Disapprove
                          </button>
                        </div>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                        <div className="flex justify-center gap-x-4">
                          <Link
                            to={`/eventBookingList/edit/${participant._id}`}
                          >
                            <AiOutlineEdit className="text-2xl text-yellow-600" />
                          </Link>
                          <Link
                            to={`/eventBookingList/delete/${participant._id}`}
                          >
