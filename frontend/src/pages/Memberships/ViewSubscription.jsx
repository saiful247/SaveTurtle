...
const ViewSubscription = () => {
  ...
  return (
    <div className="p-6 bg-blue-50 min-h-screen">
      <h1 className="text-4xl font-bold text-center text-blue-800 mb-8">Subscription Details</h1>
      <div className="border-2 border-blue-400 rounded-lg shadow-lg p-6 mx-auto w-full max-w-md bg-white">
        <div className="flex items-center justify-center mb-4">
          ...
          <h2 className="text-2xl font-semibold">Your Subscription Information</h2>
        </div>
        <div className="mb-4">
          <p className="text-lg">
        ...
        <div className="mb-4">
          <p className="text-lg">
            <strong>Subscription Date:</strong> {new Date(subscription.createdAt).toLocaleString()}
          </p>
        </div>
        <button
          onClick={generatePDF}
